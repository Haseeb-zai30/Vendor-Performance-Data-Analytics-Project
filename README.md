...
- 📓 **Documentation**  
  👉 [Open Document](https://github.com/Haseeb-zai30/Vendor-Performance-Data-Analytics-Project/blob/main/vendor_data_analytics_project.pdf)
...
├── vendor-data-analytics-project.ipynb
├── dashboard.pbix
...
<p>
The dataset contains vendor, product, and transaction-level information that enables
a holistic analysis of performance across multiple dimensions.
</p>

<ul>
    <li>Vendor identifiers and categories</li>
    <li>Sales revenue and quantities</li>
    <li>Purchase and selling prices</li>
...
<ol>
    <li>Clone the repository:
        <pre>
git clone https://github.com/Haseeb-zai30/Vendor-Performance-Data-Analytics-Project.git
        </pre>
    </li>
